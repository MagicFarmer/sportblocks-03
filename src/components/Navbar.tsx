    ...
    <nav className="relative z-50 px-6 py-4">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center space-x-8">
          ...
          <Link to="/athletes" className="text-gray-300 hover:text-white transition-colors duration-200">
            Athletes
          </Link>
          ...
          {isWalletConnected && (
            <>
              ...
              <Link to="/create-nft" className="text-gray-300 hover:text-white transition-colors duration-200">
                Create NFT
              </Link>
            </>
          )}
      ...
      {isMenuOpen && (
        <div className="md:hidden absolute top-full left-0 right-0 bg-black/90 backdrop-blur-lg border-t border-gray-800">
          <div className="px-6 py-4 space-y-4">
            ...
            <Link to="/athletes" className="block text-gray-300 hover:text-white transition-colors duration-200">
              Athletes
            </Link>
            <Link to="/marketplace" className="block text-gray-300 hover:text-white transition-colors duration-200">
              Marketplace
            </Link>
            {isWalletConnected && (
              <>
                <Link to="/dashboard" className="block text-gray-300 hover:text-white transition-colors duration-200">
                  Dashboard
                </Link>
                <Link to="/create-nft" className="block text-gray-300 hover:text-white transition-colors duration-200">
                  Create NFT
                </Link>
              </>
            )}
