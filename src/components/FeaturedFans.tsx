    ...
    <section className="px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center">
          <div className="bg-gradient-to-r from-purple-500/20 to-blue-600/20 backdrop-blur-lg rounded-2xl p-6 sm:p-8 border border-purple-400/30 max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                ...
                size="lg"
                className="w-full sm:w-auto bg-gradient-to-r from-purple-500 to-blue-600 hover:from-purple-600 hover:to-blue-700 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-lg font-medium text-sm sm:text-base"
              >
            ...
            <div className="flex items-center justify-center mt-4 text-gray-400 text-sm">
              ...
              <span>{mockFans.length}+ professionals</span>
              <span className="mx-2">•</span>
              <span>Various specialties</span>
            </div>
          </div>
        </div>
      </div>
